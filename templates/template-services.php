...
<main class="home-main centering">
    <section class="services-page">
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Автоперевозка морских контейнеров по России и Белоруси"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("ЖД доставка морских контейнеров из Китая"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Автовоз для доставки автомобилей по России и из Китая"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("⁠Перевозка негабаритных грузов"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Морские контейнерные перевозки из Китая"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Доставка сборных грузов из Китая"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Фулфилмент: доставка товаров для маркетплейсов из Китая"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Страхование грузов"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Таможенное оформление «за печатью» клиента"); ?>">Подробнее</a>
        </div>
        <div class="service-page_item">
            ...
            <a href="<?php echo get_permalink_by_title("Доставка из Китая «под ключ»"); ?>">Подробнее</a>
        </div>
    </section>
